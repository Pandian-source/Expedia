...
public class GetElementSCreenShot {
	...
	public void expedia() throws IOException, InterruptedException
	{
		...
		Thread.sleep(6000);
		WebElement element1 = driver.findElement(By.xpath("//div/div/div[1][starts-with(@id,'celtra-object-')]"));
		Screenshot Resultspage = new AShot().takeScreenshot(driver,element1);
		ImageIO.write(Resultspage.getImage(),"png",new File("C:\\Users\\Pandiyan\\eclipse-workspace\\Expedia\\Folder3\\test.png"));
		File f = new File ("C:\\Users\\Pandiyan\\eclipse-workspace\\Expedia\\Folder3\\test.png");
		if(f.exists())
		{
